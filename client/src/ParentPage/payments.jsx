...
function ParentPayments({ data }){
    ...
    const [showChooseTutor, setChooseTutor] = useState(false)
    const [chosenTutor, setchosenTutor] = useState(-1)
        ...
        if (chosenTutor===-1){
            ...
            await axios.post(
                ...
                then(res =>{
                    ...
                    setShown(`For Tutoring Session: ${clientDesc}`)
                    setShowFilter("all")
                    setChooseTutor(false)
                    })
        }
    }
    ...
    return(
        ...
        <div className='w-screen h-screen flex flex-col min-h-0 bg-gray-50'>
            ...
            <div className="px-6 pb-5 pt-2 flex flex-col w-full">
            ...
            <Modal open={showChooseTutor} onClose={() => setChooseTutor(false)}>
            <div className="p-2 w-72">
                <h3 className="text-base font-semibold text-gray-800 mb-3">Filter by tutoring session</h3>
                <select
                ...
                >
                <option value={-1}>Choose a tutoring session</option>
                {tutors.map(({ clientlink, description }) => (
